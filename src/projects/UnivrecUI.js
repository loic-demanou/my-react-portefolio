                                ...
                                <div className="col-lg-4">
                                    <div className="portfolio-info">
                                        ...
                                        <ul>
                                            ...
                                            <li><strong>Project URL</strong>: <a href="https://drive.google.com/drive/folders/1xLtMSeAf5sTdQeVMzTmuQ-fhe3GqKgfu" target="_blank">Ouvrir le lien des images de la maquette</a></li>
                                        </ul>
                                    </div>
                                    <div className="portfolio-description">
                                        ...
                                        <p><strong>Fontionnalités</strong>:<br />
                                            ...
                                            <i class='bx bx-right-arrow-alt'></i> Connexions avec google</p>
                                    </div>
                                </div>
                            </div>
                        </div>
